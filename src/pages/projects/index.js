...
function ProjectPage() {
    ...
    return (
        <div className={styles['projectPage']} style={{ backgroundColor: theme.secondary }}>
            ...
            <div className={styles['projectPage-header']} style={{ backgroundColor: theme.primary }}>
                <Link href="/">
            ...
            <div className={styles['projectPage-container']}>
                <div className={styles['projectPage-search']}>
                    <input
                        type="text"
                        value={search}
                ...
                <div className={styles['project-container']}>
                    <Grid className={styles['project-grid']} container direction="row" alignItems="center" justifyContent="center">
